...
#Program runs on CodeSkulptor: http://www.codeskulptor.org/
import simplegui
import math
import random
...
missile_info = ImageInfo([5,5], [10, 10], 3, lifespan = 50)
...
def group_collide(group, other_object):
    ...
    for explosion in set(group):
        if explosion.collide(other_object) == True:
